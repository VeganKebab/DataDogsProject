 ...
 */
final class Version20190517120936 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN reset_token VARCHAR(32) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN reset_token_expires_at INTEGER DEFAULT NULL');
    }
